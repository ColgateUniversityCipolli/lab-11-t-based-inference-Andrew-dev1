...
\begin{enumerate}
  \item Question 4, part(a).The data is greater than the rejection zone, and the p-value is incredibly small, so the mean is probably not 0. 
...
\end{figure}
  ...
  \item Question 4, part(b). The data is less than the rejection zone, and the p-value is incredibly small, so the mean is probably not 0.
...
\end{figure}
  ...
  \item Question 4, part(c). The data is not within the rejection zone, and the p-value is incredibly small, so the mean is probably not 0.
